					...
					<div class="col-12">
						<div class="hero-card1">
							...
							<div class="card-content">
								<h3>Você está prestes a trocar <strong><?= htmlspecialchars($produto['moeda']); ?> moedas</strong> pelo produto <strong><?= htmlspecialchars($produto['nome']); ?></strong>.</h3> 
								<p>Confirma?</p> <!-- Descrição  -->
                                <div>
                                <br>

...
<html lang="pt">
    ...
    <body>
        <nav class="navigation">
            <a href="https://coinz.echotec.online" rel="nofollow" target="_blank">
                <img src="asset/img/coinz.png" alt="coinz" width="250">
            </a>
        </nav>
        <div class="content">
            <svg 
            ...
            <h1>Caminho errado!</h1>
            <p>Parece que você tentou chegar até aqui sem escanear seu QR code 😠</p>
            <div class="link-container">
                <a 
                    class=link
                    href="https://game.echotec.online/login.php"
                    rel="nofollow"
                    target="_blank"
                >
                    Professor? Faça Login 
                ...
                <a 
                    class="link"
                    href="https://coinz.echotec.online/home"
                    rel="nofollow"
                    target="_blank"
                >
                    Conheça a CoinZ

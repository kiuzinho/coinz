...
?>
    <div class="col-6-sm">
        <div class="product option" onclick="savePreference('avatar', '<?= htmlspecialchars($avatar, ENT_QUOTES, 'UTF-8'); ?>')">
...
?>
        ...
        <div class="featured-product">
            <div class="content-img <?= htmlspecialchars($fundo); ?> fundo-option" data-fundo="<?= htmlspecialchars($fundo); ?>" onclick="savePreference('fundo', '<?= htmlspecialchars($fundo); ?>')"></div>
            <div class="product-detail">
                <h4 class="product-name">Fundo <?= ucfirst($fundo); ?></h4>
				<p class="price">Grátis</p>
                <!-- Opcional: adicionar descrição ou nome do fundo -->
            </div>
            <div class="star">
